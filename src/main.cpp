/** @file main.cpp
 * @brief main/debug executable for Assignment Dictionaries
 *   and hashing.
 *
 * @author Derek Harter
 ...
 * @date   June 1, 2021
 *
 * Implementation of hashing dictionary container.
 *
...
int main(int argc, char** argv)
{
  ...
  cout << "Hello Assignment Dictionaries and Hashing" << endl;
